                ...
                <nav class="navbar navbar-expand-md">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="view/best.jsp"><p class="default-font">BEST</p></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="view/event.jsp"><p class="default-font">EVENT</p></a>
                                </li>
                            ...
                            <div class="nav-account d-none d-md-block">
                                ...
                                <a href="view/login.jsp"><i class="fa-solid fa-user"></i></a>
                            </div>
                        </div>
                    </div>
                </nav>
